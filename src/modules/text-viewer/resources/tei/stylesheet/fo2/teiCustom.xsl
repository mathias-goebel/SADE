...
<xsl:stylesheet xmlns="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:fotex="http://www.tug.org/fotex" version="1.0">
    <xsl:import href="tei.xsl"/><!-- oXygen begin change --><!--
        ...
        standard one.
    -->
    <xsl:param name="tableAlign">left</xsl:param><!-- oXygen end change -->
        ...
        <xsl:choose>
            ...
            <xsl:when test="$inlineTables or @rend='inline'">
                <xsl:if test="tei:head">
                    <block>
                        <xsl:call-template name="tableCaptionstyle"/><!-- oXygen begin change --><!-- 
                        ...
                        --><!-- <xsl:call-template name="addID"/> --><!-- oXygen end change -->
