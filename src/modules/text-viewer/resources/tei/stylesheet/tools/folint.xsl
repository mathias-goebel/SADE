...
<xsl:stylesheet xmlns:rx="http://www.renderx.com/XSL/Extensions" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" exclude-result-prefixes="fo rx">
    ...
    <xsl:template match="fo:root">
        ...
        <xsl:apply-templates select="*[not(self::rx:meta-info                                   or self::fo:layout-master-set                                   or self::fo:declarations                                   or self::rx:outline                                   or self::fo:page-sequence)]" mode="report-intrusive-elements"/>
    ...
    <xsl:template match="fo:layout-master-set">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:simple-page-master                                   or self::fo:page-sequence-master)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:simple-page-master">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:region-body                                   or self::fo:region-before                                   or self::fo:region-after                                   or self::fo:region-start                                   or self::fo:region-end)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:page-sequence-master">
        ...
        <xsl:apply-templates select="*[not(self::fo:single-page-master-reference                                   or self::fo:repeatable-page-master-reference                                   or self::fo:repeatable-page-master-alternatives)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:repeatable-page-master-alternatives">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:conditional-page-master-reference)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="rx:bookmark">
        ...
        <xsl:apply-templates select="*[not(self::rx:bookmark                                   or self::rx:bookmark-label)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:page-sequence">
        ...
        <xsl:apply-templates select="*[not(self::fo:title                                   or self::fo:static-content                                   or self::fo:flow)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:table-and-caption">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:table-caption                                   or self::fo:table                                   or self::fo:marker)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:table">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:table-column                                   or self::fo:table-header                                   or self::fo:table-footer                                   or self::fo:table-body                                   or self::fo:marker)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:table-body | fo:table-header | fo:table-footer">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:table-row                                   or self::fo:table-cell                                   or self::fo:marker)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:list-block">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:list-item or self::fo:marker)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:list-item">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:list-item-label                                   or self::fo:list-item-body                                   or self::fo:marker)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:footnote">
        ...
        <xsl:apply-templates select="*[not(self::fo:inline                                   or self::fo:footnote-body)]" mode="report-intrusive-elements">
    ...
    <xsl:template match="fo:multi-properties">
        <xsl:apply-templates select="@*"/>
        <xsl:call-template name="no-text"/>
        <xsl:apply-templates select="*[not(self::fo:multi-property-set                                   or self::fo:wrapper)]" mode="report-intrusive-elements">
    ...
    <xsl:template name="block-level">
        ...
        <xsl:apply-templates select="*[not(self::fo:block                                   or self::fo:block-container                                   or self::fo:list-block                                   or self::fo:table                                   or self::fo:table-and-caption                                   or self::fo:float                                   or self::fo:wrapper                                   or self::fo:marker                                   or self::fo:retrieve-marker                                   or self::fo:multi-switch                                   or self::fo:multi-properties                                   or self::rx:ruler                                   or self::rx:begin-index-range                                   or self::rx:end-index-range                                   or self::rx:flow-section)]" mode="report-intrusive-elements-block">
            <xsl:with-param name="reason">Only block-level elements are permitted in this context.</xsl:with-param>
        </xsl:apply-templates>
    ...
    <xsl:template match="fo:wrapper/*                    | fo:inline/*                    | fo:basic-link/*                    | fo:bidi-override/*                    | fo:multi-toggle/*                    | fo:multi-properties/*                    | fo:multi-case/*" mode="report-intrusive-elements-inline">
        <xsl:param name="reason" select="''"/>
        <xsl:call-template name="print-error">
            <xsl:with-param name="msg">
    ...
    <xsl:template priority="3" match="@border-before-color                    | @border-after-color                    | @border-start-color                    | @border-end-color                    | @border-top-color                    | @border-bottom-color                    | @border-left-color                    | @border-right-color"/>
    <xsl:template priority="3" match="@border-before-style                    | @border-after-style                    | @border-start-style                    | @border-end-style                    | @border-top-style                    | @border-bottom-style                    | @border-left-style                    | @border-right-style">
        <xsl:call-template name="enumerated-values">
            <xsl:with-param name="valuelist"> none hidden dotted dashed solid double groove ridge inset outset inherit </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
    <xsl:template priority="3" match="@border-before-width                    | @border-before-width.length                    | @border-after-width                    | @border-after-width.length                    | @border-start-width                    | @border-start-width.length                    | @border-end-width                    | @border-end-width.length                    | @border-top-width                    | @border-bottom-width                    | @border-left-width                    | @border-right-width">
        <xsl:call-template name="quantitative-values">
    ...
    <xsl:template priority="3" match="@padding-before                    | @padding-before.length                    | @padding-after                    | @padding-after.length                    | @padding-start                    | @padding-start.length                    | @padding-end                    | @padding-end.length                    | @padding-top                    | @padding-bottom                    | @padding-left                    | @padding-right">
        <xsl:call-template name="quantitative-values">
            <xsl:with-param name="valuelist"> inherit </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template priority="5" match="fo:region-body/@margin-top                    | fo:region-body/@margin-bottom                    | fo:region-body/@margin-left                    | fo:region-body/@margin-right                    | fo:simple-page-master/@margin-top                    | fo:simple-page-master/@margin-bottom                    | fo:simple-page-master/@margin-left                    | fo:simple-page-master/@margin-right">
        <xsl:call-template name="quantitative-values"/>
    </xsl:template>
    ...
    <xsl:template match="@text-align">
        <xsl:call-template name="disable-on-atomic-inlines"/>
        <xsl:variable name="keyword-charset" select="'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'"/>
    ...
    <xsl:template priority="5" match="fo:region-before/@extent                    | fo:region-after/@extent                    | fo:region-start/@extent                    | fo:region-end/@extent">
        <xsl:call-template name="quantitative-values"/>
    </xsl:template>
    ...
    <xsl:template priority="5" match="fo:simple-page-master/@master-name                    | fo:page-sequence-master/@master-name"/>
    <xsl:template priority="5" match="fo:page-sequence/@master-reference                    | fo:single-page-master-reference/@master-reference                    | fo:repeatable-page-master-reference/@master-reference                    | fo:conditional-page-master-reference/@master-reference"/>
    <xsl:template priority="5" match="fo:repeatable-page-master-reference/@maximum-repeats                    | fo:repeatable-page-master-alternatives/@maximum-repeats">
        <xsl:call-template name="quantitative-values">
    ...
    <xsl:template priority="5" match="fo:simple-page-master/@page-height                    | fo:simple-page-master/@page-width">
        <xsl:call-template name="quantitative-values">
            <xsl:with-param name="valuelist"> auto indefinite </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
    <xsl:template priority="5" match="fo:region-before/@precedence                    | fo:region-after/@precedence                    | fo:region-start/@precedence                    | fo:region-end/@precedence">
        <xsl:call-template name="enumerated-values">
            <xsl:with-param name="valuelist"> true false </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template priority="3" match="@border-top                    | @border-bottom                    | @border-left                    | @border-right"/>
    ...
    <xsl:template priority="5" match="fo:simple-page-master/@margin                    | fo:region-body/@margin"/>
