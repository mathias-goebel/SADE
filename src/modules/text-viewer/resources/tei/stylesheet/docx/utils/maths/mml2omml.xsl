...
--><!-- %%Template: SReplace
    ...
    <xsl:template name="CreateRunProp">
        ...
        <w:rPr>
            ...
            <w:rFonts w:ascii="{$font-family}" w:eastAsia="{$font-family}" w:hAnsi="{$font-family}" w:cs="{$font-family}"/>
            <xsl:choose>
                <xsl:when test="$fontweight=''"/>
    ...
    <xsl:template mode="mml" match="mml:mi[child::mml:mglyph] |                        mml:mn[child::mml:mglyph] |                        mml:mo[child::mml:mglyph] |                        mml:ms[child::mml:mglyph] |                        mml:mtext[child::mml:mglyph]">
