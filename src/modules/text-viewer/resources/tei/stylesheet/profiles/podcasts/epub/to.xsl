...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="tei" version="2.0"><!-- import base conversion style -->
    ...
    <xsl:template name="stdheader">
        ...
        <xsl:variable name="link" select="ancestor-or-self::tei:TEI/tei:teiHeader/tei:fileDesc/tei:publicationStmt/tei:idno[@type='link']"/>
        ...
        <div class="transcriptSummary">
            ...
            <p>Presenter(s): <xsl:call-template name="generateAuthor"/>
            </p>
