    ...
    <xsl:template match="person-group">
        <person-group>
            <xsl:if test="@person-group-type">
                <xsl:if test="@person-group-type='allauthors' or                        @person-group-type='assignee' or                        @person-group-type='author' or                        @person-group-type='compiler' or                        @person-group-type='director' or                        @person-group-type='editor' or                        @person-group-type='guest-editor' or                        @person-group-type='inventor' or                        @person-group-type='transed' or                        @person-group-type='translator'">
                    <xsl:copy-of select="@person-group-type"/>
                </xsl:if>
            </xsl:if>
            <xsl:apply-templates/>
        </person-group>
